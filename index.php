        ...
        <div class="testimonial">
          <blockquote>
            <p>
              ...
              consectetur placeat perferendis.
              <footer class="info-testimonial clearfix">
                <img src="img/tom.jpg" alt="testimonial">
                <cite>Tom Del Valle José <span>Diseñador en @Cute</span></cite>
              </footer>
            </p>
          </blockquote>
        </div><!--Fin del testimonial-->
        <div class="testimonial">
          <blockquote>
            <p>
              ...
              consectetur placeat perferendis.
              <footer class="info-testimonial clearfix">
                <img src="img/gabby1.jpg" alt="testimonial">
                <cite>Gabriela "gnox" Contrera <span>Desarrollador en @react.js</span></cite>
              </footer>
            </p>
          </blockquote>
        </div><!--Fin del testimonial-->
